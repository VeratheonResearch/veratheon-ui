...
<div class="space-y-8">
		...
		<div class="card-body p-6">
			...
			{:else}
				<div class="flex flex-col items-center justify-center py-8 text-base-content/60">
					...
					<p class="mb-1 text-lg font-medium">No stock selected</p>
	...
	{#if symbol}
		...
		{:else if error}
			<div class="card border border-error/30 bg-base-100 shadow-lg">
				<div class="card-body p-6">
					<div class="mb-2 flex items-center gap-3 text-error">
						<svg
